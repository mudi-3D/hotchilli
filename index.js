...
class MudiExperiencePDP {
    ...
    createStyles() {
        ...
        link.href = `https://cdn.jsdelivr.net/gh/mudi-3D/hotchilli@latest/index.css`; /* custom this path */
